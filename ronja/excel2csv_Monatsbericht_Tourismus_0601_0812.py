...
output_parent_directory = 'C:\\Users\\Ronja\\Documents\\Studium\\Semester 4\\DABI2\\Projekt\\Umsatzdaten\\DESTATIS\\Output\\0601_0812\\'
os.makedirs(output_parent_directory, exist_ok=True)

# Define a dictionary to specify row ranges and columns for each sheet
sheet_specs = {
    '4.1': {'row_range': (13, 81), 'columns': ['A', 'B', 'C', 'D', 'E', 'F']},
    '4.2': {'row_range': (13, 86), 'columns': ['A', 'B', 'C', 'D', 'E', 'F']},
    '5': {'row_range': (14, 33), 'columns': ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H']},
